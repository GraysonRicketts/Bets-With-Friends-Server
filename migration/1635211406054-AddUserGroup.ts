...
export class AddUserGroup1635211406054 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_group" ("priveleges" character varying NOT NULL, "user_id" uuid NOT NULL, "group_id" uuid NOT NULL, "userId" uuid, "groupId" uuid, CONSTRAINT "PK_bd332ba499e012f8d20905f8061" PRIMARY KEY ("user_id", "group_id"))`);
